...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-cream text-slate-900 antialiased">
        <nav class="fixed top-0 z-50 w-full border-b border-white/10 bg-white/10 backdrop-blur-md">
            <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4 text-white">
                <a href="#home" class="text-lg font-semibold tracking-wide">CafeKita</a>
                ...
                <a href="#reservation" class="hidden rounded-full bg-white/20 px-5 py-2 text-sm font-semibold text-white transition hover:bg-white/30 md:inline-flex">Reservasi</a>
            </div>
        </nav>
        ...
        <main>
            <section id="home" class="relative flex min-h-screen items-center justify-center">
                <div class="absolute inset-0">
                    <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=1600&q=80" alt="Cafe interior" class="h-full w-full object-cover" />
                    <div class="absolute inset-0 bg-black/60"></div>
                </div>
                <div class="relative z-10 mx-auto w-full max-w-6xl px-6 text-center text-white">
                    <h1 class="text-6xl font-bold leading-tight">Cafe Kita Coffee Experience</h1>
                    ...
                    <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
                        <a href="#menu" class="rounded-full border border-white px-6 py-2 text-sm font-semibold text-white transition hover:bg-white/10">Lihat Menu</a>
                        <a href="#reservation" class="rounded-full bg-white px-6 py-2 text-sm font-semibold text-primary shadow-lg transition hover:-translate-y-0.5">Reservasi</a>
                    </div>
                </div>
            </section>

            <section id="about" class="relative flex min-h-screen items-center overflow-hidden bg-white bg-repeat" style="background-image: url('{{ asset('images/pattern-bg.jpg') }}');">
                ...
                <div class="relative z-10 mx-auto w-full max-w-6xl px-16 md:px-24">
                    <div class="max-w-4xl -mt-32 md:-ml-48">
                        ...
                        <div>
                            ...
                            kami terhadap biji kopi nusantara, kami menghadirkan ruang di mana setiap orang bisa merasa seperti di rumah sendiri.
                            </p>
                        </div>
                        <div>
                            <p class="mt-10 text-2xl text-slate-700 ml-8 md:ml-16">
                                Setiap tindakan latte kami sajikan dalam bentuk dedikasi kami untuk menciptakan momen hangat bagi komunitas. Di sini,
                            kamu bukan sekadar pelanggan, kamu adalah bagian dari cerita kami.
                            </p>
                        </div>
                        <div>
                            <p class="mt-10 text-2xl text-slate-700 ml-16 md:ml-32">
                                Setiap tindakan latte kami sajikan dalam bentuk dedikasi kami untuk menciptakan momen hangat bagi komunitas. Di sini,
                            kamu bukan sekadar pelanggan, kamu adalah bagian dari cerita kami."
                            </p>
                        </div>
            ...
            <section id="menu" class="flex min-h-screen items-center bg-linear-to-br from-[#003B2F] via-primary to-[#018568] py-24">
                <div class="mx-auto w-full max-w-6xl px-6 text-white">
                    <div class="text-center">
                        <p class="text-sm font-semibold uppercase tracking-[0.2em] text-white">MENU</p>
                        <h2 class="mt-2 text-4xl font-serif font-semibold text-white">Signature</h2>
                    </div>
                    <div class="mt-16 grid grid-cols-1 gap-10 md:grid-cols-3">
                        <div class="relative mt-32 flex flex-col items-center rounded-[60px] bg-[#006050]/60 px-6 pb-12 pt-36 text-center backdrop-blur-sm">
                            <img
                                src="{{ asset('images/menu-nasi-goreng.png') }}"
                                alt="Nasi Goreng"
                                class="absolute -top-20 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full border-4 border-transparent object-cover shadow-[0_20px_30px_-10px_rgba(0,0,0,0.5)] md:h-56 md:w-56"
                            />
                            <h3 class="mt-4 text-2xl font-bold text-[#FFB800]">Nasi Goreng</h3>
                            <p class="mt-4 text-center text-sm text-white/80">
                                Mahakarya kuliner berbumbu rempah khas dengan aroma smoky autentik dan tekstur sempurna.
                            </p>
                        </div>
                        <div class="relative mt-32 flex flex-col items-center rounded-[60px] bg-[#006050]/60 px-6 pb-12 pt-36 text-center backdrop-blur-sm">
                            <img
                                ...
                                class="absolute -top-20 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full border-4 border-transparent object-cover shadow-[0_20px_30px_-10px_rgba(0,0,0,0.5)] md:h-56 md:w-56"
                            />
                            <h3 class="mt-4 text-2xl font-bold text-[#FFB800]">Ayam Goreng</h3>
                            <p class="mt-4 text-center text-sm text-white/80">
                                Memadukan kulit super renyah dan daging lembut kaya rempah untuk cita rasa premium.
                            </p>
                        </div>
                        <div class="relative mt-32 flex flex-col items-center rounded-[60px] bg-[#006050]/60 px-6 pb-12 pt-36 text-center backdrop-blur-sm">
                            <img
                                ...
                                class="absolute -top-20 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full border-4 border-transparent object-cover shadow-[0_20px_30px_-10px_rgba(0,0,0,0.5)] md:h-56 md:w-56"
                            />
                            <h3 class="mt-4 text-2xl font-bold text-[#FFB800]">Mie Goreng</h3>
                            <p class="mt-4 text-center text-sm text-white/80">
                                Kombinasi mie kenyal dan bumbu aromatik dengan sentuhan elegan untuk tiap suapan.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="reservation" class="relative flex min-h-screen items-center overflow-hidden bg-linear-to-br from-[#003B2F] via-primary to-[#018568]">
                <img
                    src="{{ asset('images/menu-mie-goreng.png') }}"
                    alt="Mie Goreng"
                ...
                <div class="relative z-10 mx-auto flex w-full max-w-6xl justify-end px-6">
                    <div class="w-full md:w-1/2 text-white">
                        <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#FFB800]">RESERVASI?</p>
                        <h2 class="mt-3 text-3xl font-semibold">Nikmati layanan prioritas untuk pengalaman terbaik.</h2>
                        ...
                        <a href="#" class="mt-6 inline-flex rounded-full bg-[#FFB800] px-6 py-3 text-sm font-semibold text-slate-900 shadow-lg transition hover:-translate-y-0.5">Reservasi</a>
                    </div>
                </div>
            </section>
        </main>
